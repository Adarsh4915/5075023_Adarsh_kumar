 ...
 *
 */
// Utility to generate primes up to needed limit
...
int* waiter(int number_count, int* number, int q, int* result_count) {
    ...
    // Create stack A (initial numbers)
